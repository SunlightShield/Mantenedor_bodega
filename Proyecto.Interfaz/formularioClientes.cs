...
namespace Proyecto.Interfaz
{
    public partial class formularioClientes : Form
    {
        ...
        private void Listar()
        {
            try
            {
                DataGridListado.DataSource = NPersona.ListarClientes();
                this.Formato();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Respuesta = NPersona.Insertar("Cliente", textBoxNombre.Text.Trim(), CbBxTipoDoc.Text, TxtBxNumeroDoc.Text.Trim(), TxtBxDireccion.Text.Trim(), TxtBxFono.Text.Trim(), txtBxEmail.Text.Trim());
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Respuesta = NPersona.Actualizar(Convert.ToInt32(textBoxId.Text), "Cliente", this.NombreAnterior, textBoxNombre.Text.Trim(), CbBxTipoDoc.Text, TxtBxNumeroDoc.Text.Trim(), TxtBxDireccion.Text.Trim(), TxtBxFono.Text.Trim(), txtBxEmail.Text.Trim());
                    if (Respuesta.Equals("OK"))
                    {
        ...
        private void CbBxTipoDoc_SelectedIndexChanged(object sender, EventArgs e)
        {
