...
{
    public partial class formularioVista_Proveedor : Form
    {
        public formularioVista_Proveedor()
        {
            InitializeComponent();
        }
        ...
        private void formularioVista_Proveedor_Load(object sender, EventArgs e)
        {
            //this.Listar();
        }
        ...
        {
            Variables.IdProveedor = Convert.ToInt32(DataGridListado.CurrentRow.Cells["ID"].Value);
            Variables.NombreProveedor = Convert.ToString(DataGridListado.CurrentRow.Cells["Nombre"].Value);
            this.Close();
        }
    }
}
