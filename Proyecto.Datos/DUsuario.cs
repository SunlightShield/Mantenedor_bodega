    ...
    public class DUsuario
    {
        public DataTable Listar()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("usuario_listar", SqlCon);//hacemos referencia a la base de datos
        ...
        public DataTable Buscar(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConn();//Devuelve ls sqlConnection
                SqlCommand Comando = new SqlCommand("usuario_buscar", SqlCon);//hacemos referencia a la base de datos
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable IniciarSesion(string Email, String Clave) //se usan las mismas propiedades del buscar
        {
            SqlDataReader Resultado;
            DataTable Tabla = new DataTable();
            SqlConnection SqlCon = new SqlConnection();
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConn();//Devuelve ls sqlConnection
                SqlCommand Comando = new SqlCommand("usuario_login", SqlCon);//hacemos referencia a la base de datos
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@email", SqlDbType.VarChar).Value = Email;//se loguea con el correo electronico del usuario
