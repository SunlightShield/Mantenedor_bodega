    ...
    public class DIngresos
    {
        public DataTable Listar()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("ingreso_listar", SqlCon);//hacemos referencia a la base de datos
        ...
        public DataTable Buscar(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConn();//Devuelve ls sqlConnection
                SqlCommand Comando = new SqlCommand("ingreso_buscar", SqlCon);//hacemos referencia a la base de datos
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Insertar(Ingresos Obj)
        {
            string Respuesta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
