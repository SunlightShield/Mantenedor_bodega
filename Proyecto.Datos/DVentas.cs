    ...
    public class DVentas
    {
        public DataTable Listar()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("venta_listar", SqlCon);//hacemos referencia a la base de datos
        ...
        public DataTable Buscar(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConn();//Devuelve ls sqlConnection
                SqlCommand Comando = new SqlCommand("venta_buscar", SqlCon);//hacemos referencia a la base de datos
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ConsultaFechas(DateTime FechaInicio, DateTime FechaFin)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConn();//Devuelve ls sqlConnection
                SqlCommand Comando = new SqlCommand("venta_consulta_fechas", SqlCon);//hacemos referencia a la base de datos
                Comando.CommandType = CommandType.StoredProcedure;
